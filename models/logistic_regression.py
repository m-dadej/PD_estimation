...
logit_cv = LogisticRegression(max_iter = 10000, penalty="elasticnet", solver='saga', verbose=3, l1_ratio=0)
logit_cv = GridSearchCV(logit_cv, param_grid = param_grid, cv = 3, verbose=3, n_jobs=1, scoring='f1')
